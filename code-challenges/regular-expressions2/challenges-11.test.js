...
Return either true or false.
------------------------------------------------------------------------------------------------ */
const validatePhoneNumber = (phoneNumber) => /^\d{10}$|\d{6}-\d{4}$|^\d{3} \d{3} \d{4}$|^\d{3}-\d{3} \d{4}$|^\d{3}-\d{7}$|^\d{3} \d{3}-\d{4}$|^\(\d{3}\)\d{3} \d{4}$|^\(\d{3}\) \d{3}-\d{4}$|^\d{3}-\d{3}-\d{4}$|^\d{3} \d{7}$/.test(phoneNumber);
